...
class Users extends Admin_Controller {
    ...
    function add()
    {
        ...
        $this->form_validation->set_rules('user_role','','required|trim|numeric');
    ...
    function edit($id = NULL)
    {
        ...
        $westernu_moneygram = $this->users_model->getUserPaymentDetail($id,'westernU_moneygram');
        $card_detail = $this->users_model->getUserPaymentDetail($id,'card_detail');
        $bank_detail = $this->users_model->getUserPaymentDetail($id,'bank_detail');
        ...
        $data = $this->includes;
        $getUserQRCode = $this->users_model->getUserQRCode($id);
        // set content data
        $content_data = array(
            'cancel_url'             => $this->_redirect_url,
            'user'                   => $user,
            ...
            'westernu_moneygram'     => $westernu_moneygram,
            'card_detail'            => $card_detail,
            'bank_detail'            => $bank_detail,
            'QRCode'                 => $getUserQRCode 
        );
