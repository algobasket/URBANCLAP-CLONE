  ...
  <div class="panel-body">
    <div class="tab-content">
                    ...
                    <div class="radio-card">
                      ...
                      <label for="7" id="7">
                        <span class="card-title"><img class="img-responsive" src="<?php echo base_url();?>themes/private/img/pay/swift.png" alt=""></span>
    							...
    							<?php endif; ?>
                  <?php if($this->commission->display->mastercard_check) : ?>
                  <div class="col-md-4 col-xs-6">
                    <div class="radio-card">
                      <div class="fee"><?php echo $this->commission->display->mastercard_check ?>% + <?php echo $this->commission->display->mastercard_fees ?> <?php echo $this->currencys->display->base_code ?></div>
                      <input type="radio" class="planes-radio" name="method" value="mastercard" id="10"/>
                      <label for="10" id="10">
                        <span class="card-title"><img class="img-responsive" src="<?php echo base_url();?>assets/img/mastercard.jpg" alt=""></span>
                      </label>
                    </div>
                  </div>
                   <?php endif; ?>
                   ...
                   <?php if($this->commission->display->westernunion_check) : ?>
                   <div class="col-md-4 col-xs-6">
                     <div class="radio-card">
                       <div class="fee"><?php echo $this->commission->display->westernunion_check ?>% + <?php echo $this->commission->display->westernunion_fees ?> <?php echo $this->currencys->display->base_code ?></div>
                       <input type="radio" class="planes-radio" name="method" value="westernunion" id="11"/>
                       <label for="11" id="11">
                         <span class="card-title"><img class="img-responsive" src="<?php echo base_url();?>assets/img/westernunion.jpg" alt=""></span>
                       </label>
                     </div>
                   </div>
                    <?php endif; ?>

                    <?php if($this->commission->display->moneygram_check) : ?>
                    <div class="col-md-4 col-xs-6">
                      <div class="radio-card">
                        <div class="fee"><?php echo $this->commission->display->moneygram_check ?>% + <?php echo $this->commission->display->moneygram_fee ?> <?php echo $this->currencys->display->base_code ?></div>
                        <input type="radio" class="planes-radio" name="method" value="moneygram" id="12"/>
                        <label for="12" id="12">
                          <span class="card-title"><img class="img-responsive" src="<?php echo base_url();?>assets/img/moneygram.jpg" alt=""></span>
                        </label>
                      </div>
                    </div>
                     <?php endif; ?>
      ...
      <div class="tab-pane" id="profile">
        ...
        <?php if($this->commission->display->mastercard_check) : ?>
					<?php echo form_open(site_url("account/mastercard/"), array("id" => "mastercard")) ?>
						<div class="row">
              <div class="col-md-12">
								<div class="form-group">
                    <label><?php echo lang('users withdrawal amount'); ?>, <?php echo $this->currencys->display->base_code ?></label>
                  ...
                  <input type="submit" name="payment_mastercard" value="Go to Payment" class="btn btn-primary" />
                </div>
							</div>
						</div>
					<?php echo form_close(); ?>
        ...
        <?php if($this->commission->display->westernunion_check) : ?>
          <?php echo form_open(site_url("account/westernunion/"), array("id" => "westernunion")) ?>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                    <label><?php echo lang('users withdrawal amount'); ?>, <?php echo $this->currencys->display->base_code ?></label>
                ...
                <div class="pull-right">
                  ...
                  <input type="submit" name="payment_westernunion" value="Go to Payment" class="btn btn-primary" />
                </div>
              </div>
            </div>
          <?php echo form_close(); ?>
        ...
        <?php if($this->commission->display->moneygram_check) : ?>
          <?php echo form_open(site_url("account/moneygram/"), array("id" => "moneygram")) ?>
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                    <label><?php echo lang('users withdrawal amount'); ?>, <?php echo $this->currencys->display->base_code ?></label>
                ...
                <div class="pull-right">
                  ...
                  <input type="submit" name="payment_moneygram" value="Go to Payment" class="btn btn-primary" />
                </div>
              </div>
            </div>
          <?php echo form_close(); ?>
