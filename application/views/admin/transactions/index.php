      ...
      <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            ...
            <tr <?php if($transaction['status']==4){?> class="danger" <?php }else{ ?><?php } ?> >
              ...
              <td<?php echo (($sort == 'type') ? ' class="sorted"' : ''); ?>>
                 ...
                 <?php }else{ ?>
                 <?php } ?>
                 <?php if($transaction['type']==3){?>
                      <?php echo lang('admin trans transfer'); ?>
                 <?php }else{ ?>
                 <?php } ?>
                 <?php if($transaction['type']==4){?>
                      <?php echo lang('admin trans exchange'); ?>
                 <?php }else{ ?>
                 <?php } ?>
                 <?php if($transaction['type']==5){?>
              ...
              <td class="center">
                  <?php if($transaction['currency']=='debit_base'){ ?>
                      <?php echo $this->currencys->display->base_code ?>
                  <?php }else{ ?>
                  <?php } ?>
                  <?php if($transaction['currency']=='debit_extra1'){?>
                      <?php echo $this->currencys->display->extra1_code ?>
                  <?php }else{ ?>
                  <?php } ?>
                  <?php if($transaction['currency']=='debit_extra2'){?>
                      <?php echo $this->currencys->display->extra2_code ?>
                  <?php }else{ ?>
                  <?php } ?>
                  <?php if($transaction['currency']=='debit_extra3'){?>
                      <?php echo $this->currencys->display->extra3_code ?>
                  <?php }else{ ?>
                  <?php } ?>
                  <?php if($transaction['currency']=='debit_extra4'){?>
                      <?php echo $this->currencys->display->extra4_code ?>
                  <?php }else{ ?>
                  <?php } ?>
                  <?php if($transaction['currency']=='debit_extra5'){?>
