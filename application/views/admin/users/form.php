    ...
    <div class="card sameheight-item items" data-exclude="xs,sm,lg">
      <div class="card-header bordered">
       ...
       <ul class="nav nav-tabs pull-right" role="tablist">
          ...
          <li class="nav-item"> <a class="nav-link" href="#bank" role="tab" data-toggle="tab"><?php echo lang('admin input bank'); ?></a></li>
       </ul>
     </div>
            ...
            <div class="panel-group" id="accordion">
                <div class="card card-default">
                  <div class="card-header">
                    <div class="header-block">
                        <a data-toggle="collapse" class="title" data-parent="#accordion" href="#znajomi">
                        <?php echo lang('users admin payment account'); ?>
                      </a>
                    </div>
                  ...
                  <div id="znajomi" class="panel-collapse collapse in">
                    <div class="card-block">
                        ...
                        <div class="row">
                          <h4>Mastercard Detail</h4>
                          <table class="table">
                            <tr>
                              <th>Card Number</th>
                              <th><?php echo json_decode($card_detail)->cardNumber;?></th>
                            </tr>
                            <tr>
                              <th>Name On Card</th>
                              <td><?php echo json_decode($card_detail)->nameOnCard;?></td>
                            </tr>
                            <tr>
                              <th>Card Type</th>
                              <td><?php echo json_decode($card_detail)->card_type;?></td>
                            </tr>
                            <tr>
                              <th>Card</th>
                              <td><?php echo json_decode($card_detail)->credit_debit;?></td>
                            </tr>
                            <tr>
                              <th>Card CVV</th>
                              <td><?php echo json_decode($card_detail)->cvv_number;?></td>
                            </tr>
                            <tr>
                              <th>Status</th>
                              <td><?php echo status(json_decode($card_detail)->status);?></td>
                            </tr>
                          </table>
                       </div>
                       <div class="row">
                         ...
                         <table class="table">
                           <tr>
                             <th>Bank Name</th>
                             <td><?php echo bankName(json_decode($bank_detail)->bank_name);?></td>
                           </tr>
                           <tr>
                             <th>Account Number</th>
                             <td><?php echo json_decode($bank_detail)->account_number;?></td>
                           </tr>
                           <tr>
                             <th>Account Holder Name</th>
                             <td><?php echo json_decode($bank_detail)->account_holder_name;?></td>
                           </tr>
                           <tr>
                             <th>Swift Code</th>
                             <td><?php echo json_decode($bank_detail)->swiftCode;?></td>
                           </tr>
                           <tr>
                             <th>Routing Number</th>
                             <td><?php echo json_decode($bank_detail)->routingNumber;?></td>
                           </tr>
                         </table>
                      </div>
                     ...
                     <div class="row">
                       ...
                       <table class="table">
                         <tr>
                           <th>Western Union ID</th>
                           <td><?php echo json_decode($westernu_moneygram)->westernUnionId;?></td>
                         </tr>
                         <tr>
                           <th>Western Union Email</th>
                           <td><?php echo json_decode($westernu_moneygram)->westernUnionEmail;?></td>
                         </tr>
                       </table>
                    </div>
                    <div class="row">
                      ...
                      <table class="table">
                        <tr>
                          <th>Moneygram ID</th>
                          <td><?php echo json_decode($westernu_moneygram)->moneyGramId;?></td>
                        </tr>
                        <tr>
                          <th>Moneygram Email</th>
                          <td><?php echo json_decode($westernu_moneygram)->moneyGramEmail;?></td>
                        </tr>
                      </table>
                   </div>
                   <div class="row">
                     <h4>QR Code Detail</h4>
                     <table class="table">
                       <tr>
                         <th>QR CODE</th>
                         <td><img src="<?php echo base_url();?>QR_CODES/<?php echo $QRCode;?>" /></td>
                       </tr>
                     </table>
                  </div>
                    </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h6 id="modal-label-<?php echo $view->id ?>"><?php if($view->type==1){?><?php echo lang('admin verification doc_user'); ?><?php }else{ ?><?php } ?><?php if($view->type==2){?><?php echo lang('admin verification doc_adress'); ?><?php }else{ ?><?php } ?><?php if($view->type==3){?><?php echo lang('admin verification doc_bus'); ?><?php }else{ ?><?php } ?></h6>
                    </div>
