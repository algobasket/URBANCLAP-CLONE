...
<body>
            ...
            <div id="navbar" class="navbar-collapse collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php else : ?>
                            ...
                            <a href="<?php echo base_url('login'); ?>" class="btn btn-danger navbar-btn"><i class="icon-user icons"></i> <?php echo lang('core button login'); ?></a>
    ...
    <?php if (isset($js_files_i18n) && is_array($js_files_i18n)) : ?>
        ...
        <?php endforeach; ?>
    <?php endif; ?>
    <script src="<?php echo base_url();?>assets/js/phoneNumber.js"></script>
      ...
      $("#mobile").intlTelInput({
        ...
        var countryCode = (resp && resp.country) ? resp.country : "";
         ...
         separateDialCode: false,
          utilsScript: "<?php echo base_url();?>assets/js/phoneNumber.js"
        });
      </script>
</body>
</html>
