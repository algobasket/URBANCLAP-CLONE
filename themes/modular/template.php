            ...
            <div class="app" id="app">
                        ...
                        <nav class="menu">
                            <ul class="nav metismenu" id="sidebar-menu">
                                ...
                                <!-- <li class="<?php //echo (uri_string() == 'admin' OR uri_string() == 'admin/loan') ? 'active' : ''; ?>">
                                  <a href="<?php //echo base_url('admin/loan'); ?>"><i class="icon-wallet icons"></i> Loan Management <i class="fa arrow"></i> </a>
                                </li> -->
                                ...
                                <li class="<?php echo (uri_string() == 'admin/fees/setting') ? 'active' : ''; ?>"> <a href="<?php echo base_url('/admin/fees/setting'); ?>">
                                Payment Setting
                          </a> </li>
                                    </ul>
                                </li>
                ...
                <footer class="footer">
                    ...
                    <div class="footer-block author">
                        <ul>
                            <li>Smart-Interim <?php echo $this->settings->site_version; ?></li>
                        </ul>
                    </div>
                </footer>
