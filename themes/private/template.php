...
<head>
  ...
  <!-- <script type="text/javascript" src="//platform-api.sharethis.com/js/sharethis.js#property=5a83c003729b770013b05945&product=inline-share-buttons"></script> -->
    ...
    <![endif]-->
    <script type="text/javascript" src="<?php echo base_url();?>assets/js/adapter.min.js"></script>
    ...
    <div class="container theme-showcase" role="main">
        ...
        <div class="page-header">
            <h2><?php echo $page_header; ?></h2>
              ...
              <!-- <a href="<?php //echo base_url('/account/loan'); ?>" class="list-group-item <?php //echo (uri_string() == 'account/loan') ? 'active' : ''; ?>">
                Apply Loan
                <i class="icon-paper-plane icons pull-right"></i>
              </a> -->
              ...
              <a href="<?php echo base_url('/account/payment_settings'); ?>" class="list-group-item <?php echo (uri_string() == 'account/payment_settings') ? 'active' : ''; ?>">
								Payment Setting
								<i class="icon-wrench icons pull-right"></i>
							</a>
						</div>
